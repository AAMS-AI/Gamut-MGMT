...
import { Plus, Trash2, Users, Edit2, Briefcase } from 'lucide-react';
...
export default function TeamsManagement() {
    ...
    // Stats Data
    const { teams: allTeams, loading: teamsLoading } = useFirestoreTeams(user);
    const [teamsFetch, setTeamsFetch] = useState([]); // Manual fetch state if needed, or derived from allTeams
    ...
    const fetchData = async () => {
        try {
            ...
            // Filter Teams
            // Unified Directory: Everyone sees all teams
    ...
    const handleDeleteTeam = async (teamId) => {
        ...
        try {
            ...
            fetchData(); // Use fetchData instead of fetchTeams which was undefined in original file? Original called fetchTeams, assume typo or it was a wrapper. fetchData exists here.
        } catch (error) {
        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-500 text-sm">Manage teams and track performance</p>
                </div>
