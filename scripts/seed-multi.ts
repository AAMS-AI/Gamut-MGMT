...
console.log('🔧 Emulator Environment Configured (Multi-Office):');
...
async function seed() {
    try {
        console.log('🌱 Starting GAMUT Multi-Office Seeding...');

        const orgId = 'org_demo_multi';
        ...
        const users = [
            { uid: 'owner_multi', email: 'owner@multi.com', role: 'OWNER', name: 'Oliver Owner', officeId: office1 }, // Owner usually has primary office but global access
